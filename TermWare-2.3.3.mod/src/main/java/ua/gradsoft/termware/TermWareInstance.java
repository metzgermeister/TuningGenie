...
public class  TermWareInstance                                 
{
  ...
  ITermRewritingStrategy  createJavaStrategy(String className) throws TermWareException
 {
   ...
   *
   *@exception  ua.gradsoft.termware.exceptions.AssertException, if <code> name </code> is not name term.
   */
  ...
  *@see ua.gradsoft.termware.IParserFactory
  *@see ua.gradsoft.termware.IParser
  **/
  ...
  *@see ua.gradsoft.termware.IPrinterFactory
  *@see ua.gradsoft.termware.IPrinter
  **/
  ...
  *@see ua.gradsoft.termware.TermFactory
  */
