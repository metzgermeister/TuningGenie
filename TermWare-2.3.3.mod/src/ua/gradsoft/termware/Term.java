...
public abstract class Term implements Serializable, Cloneable
{
  ...
  *@see ua.gradsoft.termware.PrimaryTypes
  ...
  *@exception ua.gradsoft.termware.exceptions.ConversionException is conversion is not possible.
  */
  ...
  *@return number value
  *@exception ua.gradsoft.termware.exceptions.ConversionException raised if conversion is impossible.
  *@exception UnsupportedOperationException raised if this term does not represent Number value.
  */
  ...
  *@return number value
  *@exception ua.gradsoft.termware.exceptions.ConversionException if conversion to byte is impossible.
  */
  ...
  *@return int value
  *@exception ua.gradsoft.termware.exceptions.ConversionException if conversion is impossible.
  **/
