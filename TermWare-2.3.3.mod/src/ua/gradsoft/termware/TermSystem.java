 ...
 *@see ua.gradsoft.termware.IFacts
 *@see ua.gradsoft.termware.ITermRewritingStrategy
 *@see ua.gradsoft.termware.IEnv
 **/
...
/**
   ...
   *@see ua.gradsoft.termware.TermSystem#isReduceFacts
   *@see ua.gradsoft.termware.TermSystem#setReduceFacts
   *@see ua.gradsoft.termware.TermSystem#setFact
   **/
   ...
   *@see ua.gradsoft.termware.TermSystem#isReduceFacts
   *@see ua.gradsoft.termware.TermSystem#checkFact
   *@see ua.gradsoft.termware.TermSystem#setFact
   */
   ...
   *@see ua.gradsoft.termware.TermSystem#setEnv
   */
   ...
   *@see ua.gradsoft.termware.IEnv
   *@see TermWareInstance#getEnv
   *@see ua.gradsoft.termware.TermSystem#getEnv
   */  
